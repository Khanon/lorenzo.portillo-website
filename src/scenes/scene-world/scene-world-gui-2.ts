...
@GUI()
export class SceneWorldGUI2 extends GUIInterface {
  onInitialize(container: BABYLONGUI.AdvancedDynamicTexture) {
    // Logger.trace('SceneWorldGUI onInitialize')
    const button1 = BABYLONGUI.Button.CreateSimpleButton('but1', 'Click Me TWO')
    button1.horizontalAlignment = BABYLONGUI.Control.HORIZONTAL_ALIGNMENT_RIGHT
    button1.width = '150px'
    button1.height = '40px'
    button1.color = 'white'
